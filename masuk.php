...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php"> Stock Barang Toko Baju</a>
        <!-- Sidebar Toggle-->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <br>
                                                        <button type="submit" class="btn btn-danger" name="hapusbarangmasuk">Hapus <?php echo $idm; ?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                ...
                <div class="modal-body">
                    ...
                    <select name="barangnya" class="form-control">
                        ...
                        while ($fetcharray = mysqli_fetch_array($ambilsemuadatanya)) {
                            ...
                            $keterangan = $fetcharray['deskripsi'];
                    ...
                    <br>
                    <input type="number" name="qty" class="form-control" placeholder="Quantity" values=<?php echo $keterangan; ?>required>
                    <br>
